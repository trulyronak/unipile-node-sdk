...
export const ProxyParamsSchema = Type.Object({
  ...
  export const MailFetchAccountSchema = Type.Object({
    full_fetch: Type.Union([MailFullFetchStarted, MailFullFetchPending]),
    fetch_progress: Type.Optional(
      Type.Array(Type.Union([FolderSyncingSchema, FolderSyncErrorSchema]))
    ),
    folder_fetch_status: Type.Optional(
      Type.Union([
        Type.Literal("IDLE"),
        Type.Literal("DONE"),
  ...
  export type ViewAccountWithSourceStatus = Static<
    typeof ViewAccountWithSourceStatusSchema
  >;
  
  export type AccountSupportedProvider = Static<
    typeof AccountSupportedProviderSchema
  >;
